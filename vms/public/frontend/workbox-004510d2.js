define(["exports"], function (t) {
	...
	const a = {
		...
		h = (t) => [a.prefix, t, a.suffix].filter((t) => t && t.length > 0).join("-"),
		u = (t) => t || h(a.precache),
		l = (t) => t || h(a.runtime);
	function f(t, e) {
		const s = e();
	...
	class b extends L {
		...
		async _(t, e) {
			...
			return (
				s ||
				(e.event && "install" === e.event.type ? await this.O(t, e) : await this.N(t, e))
			);
		}
		async N(t, e) {
			let n;
	...
	(b.defaultPrecacheCacheabilityPlugin = {
		...
		(b.copyRedirectedCacheableResponsesPlugin = {
			cacheWillUpdate: async ({ response: t }) => (t.redirected ? await g(t) : t),
		});
	class C {
	...
	function N(t) {
		...
		!(function (t, e, n) {
			...
			(c || ((c = new o()), c.addFetchListener(), c.addCacheListener()), c).registerRoute(a);
		})(new x(e, t));
	}
