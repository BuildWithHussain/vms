      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-2">
          {project && (
            <>
              <span
                className="cursor-pointer text-xs text-muted-foreground hover:text-foreground truncate"
          ...
          {category && <Badge variant="outline" className="shrink-0 text-[10px]">{category}</Badge>}
        </div>
      </div>
